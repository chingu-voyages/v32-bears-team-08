      ...
      <div className={styles["app-info"]}>
        ...
        {state.login && (
          <>
            ...
            <br />
            <span className={styles["toggle"]}>Demo account </span>
            <span className={styles["toggle"]}>Email: bill@email.com </span>
            <span className={styles["toggle"]}>Password: Chingu32! </span>
          </>
        )}
      </div>
    </div>
